...
"background-color: rgb(137, 218, 199);")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Add Module Content"))
        self.lbl_heading.setText(_translate("Form", "Add Module Content"))
        self.lbl_category.setText(_translate("Form", "Category"))
        self.cmb_category.setItemText(0, _translate("Form", "Select category"))
        self.cmb_category.setItemText(1, _translate("Form", "Noun"))
        self.cmb_category.setItemText(2, _translate("Form", "Verb"))
        self.cmb_category.setItemText(3, _translate("Form", "Association"))
        self.cmb_category.setItemText(4, _translate("Form", "Activity"))
        self.lbl_lesson_id.setText(_translate("Form", "Lesson ID"))
        ...
        self.btn_select_photo.setText(_translate("Form", "Select Photo/Video"))
